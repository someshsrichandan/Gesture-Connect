...
const TextToSignAlternate = () => {
  ...
  const signDictionary: Record<string, { source: ImageSourcePropType; isGif: boolean }> = {
    ...
    'c': { source: require('../assets/signs/letters/c.jpg'), isGif: false },
    'd': { source: require('../assets/signs/letters/d.jpg'), isGif: false },
    'e': { source: require('../assets/signs/letters/e.jpg'), isGif: false },
    'f': { source: require('../assets/signs/letters/f.jpg'), isGif: false },
    'g': { source: require('../assets/signs/letters/g.jpg'), isGif: false },
    'h': { source: require('../assets/signs/letters/h.jpg'), isGif: false },
    'i': { source: require('../assets/signs/letters/i.jpg'), isGif: false },
    'j': { source: require('../assets/signs/letters/j.jpg'), isGif: false },
    'k': { source: require('../assets/signs/letters/k.jpg'), isGif: false },
    'l': { source: require('../assets/signs/letters/l.jpg'), isGif: false },
    'm': { source: require('../assets/signs/letters/m.jpg'), isGif: false },
    'n': { source: require('../assets/signs/letters/n.jpg'), isGif: false },
    'o': { source: require('../assets/signs/letters/o.jpg'), isGif: false },
    'p': { source: require('../assets/signs/letters/p.jpg'), isGif: false },
    'q': { source: require('../assets/signs/letters/q.jpg'), isGif: false },
    'r': { source: require('../assets/signs/letters/r.jpg'), isGif: false },
    's': { source: require('../assets/signs/letters/s.jpg'), isGif: false },
    't': { source: require('../assets/signs/letters/t.jpg'), isGif: false },
    'u': { source: require('../assets/signs/letters/u.jpg'), isGif: false },
    'v': { source: require('../assets/signs/letters/v.jpg'), isGif: false },
    'w': { source: require('../assets/signs/letters/w.jpg'), isGif: false },
    'x': { source: require('../assets/signs/letters/x.jpg'), isGif: false },
    'y': { source: require('../assets/signs/letters/y.jpg'), isGif: false },
    'z': { source: require('../assets/signs/letters/z.jpg'), isGif: false },
    // ... other letters ...
